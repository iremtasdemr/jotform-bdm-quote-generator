  ...
  $("#quotePaper").innerHTML = `
    ...
    <table class="quote-info-table" aria-label="Quote details">
      ...
      <tbody>
        ...
        <tr class="quote-info-seller-row"><td class="quote-company-block"><p><strong>${editable(state.text.sellerName, 'data-text-key="sellerName"')}</strong></p><p>${editable(state.text.sellerAddress, 'data-text-key="sellerAddress"', "quote-address")}</p></td><td></td><td></td><td></td></tr>
